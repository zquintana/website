...
export const recommendations: Record<string, Recommendation> = {
  ...
  planning: { id: 'planning', title: 'Create a simple technology plan', action: 'Document the next 12 months of technology priorities, lifecycle needs, risks, and expected spending.', why: 'A lightweight plan reduces emergency spending and connects technology decisions to business goals.', priority: 6 },
...
const findingCopy: Record<string, { title: string; why: string; nextStep: string }> = {
  ...
  'Reactive technology spending': { title: 'Technology spending is reactive', why: 'Emergency decisions can cost more and may not address the underlying business need.', nextStep: recommendations.planning.action },
