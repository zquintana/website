...
export const privilegedAccessQuestions: CapabilityQuestion[] = [
  {
    ...
    allowUnknown: true,
    unknownBehavior: { type: 'provisional-score', score: 1, rationale: 'Unknown admin MFA status indicates limited security visibility.' },
    importance: 5,
    severity: 'critical',
    foundational: true,
  ...
  },
  {
    ...
    allowUnknown: true,
    unknownBehavior: { type: 'provisional-score', score: 1, rationale: 'Unknown shared-account use weakens accountability.' },
    importance: 4,
    severity: 'high',
