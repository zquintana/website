...
| Modular finding conditions execute | [Risk/findings](../methodology/risk-and-findings.md) | `methodology/findings.ts`, browser methodology bridge | operator, all/any, unknown, N/A, and methodology finding tests | Partial; browser bridge duplicates evaluator |
